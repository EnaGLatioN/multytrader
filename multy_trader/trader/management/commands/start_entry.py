...
class Command(BaseCommand):
    ...
    def futures_buy(self, price_checker_long, price_checker_short, long_order, short_order, entry, flag, status):
        ...
        if entry.entry_course > 0 and not entry.reverse:
        ...
        if entry.reverse and entry.entry_course < 0:
            self.ultra_negativ_entry(price_checker_long, price_checker_short, status, entry, long_order, short_order, flag)
        if entry.reverse and entry.entry_course > 0:
            self.ultra_plural_entry(price_checker_long, price_checker_short, status, entry, long_order, short_order, flag)
